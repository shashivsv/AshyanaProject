...
namespace Ashyana.UI.Web.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "propertyTypeID,propertyType1,propertyTypeDesc,propertyTypeDelete,propertyTypeDeletedOn,propertyTypeCreatedBy,propertyTypeCreatedOn,propertyTypeUpdatedBy,propertyTypeUpdatedOn")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "propertyTypeID,propertyType1,propertyTypeDesc,propertyTypeDelete,propertyTypeDeletedOn,propertyTypeCreatedBy,propertyTypeCreatedOn,propertyTypeUpdatedBy,propertyTypeUpdatedOn")] PropertyType propertyType)
        {
            if (ModelState.IsValid)
            {
