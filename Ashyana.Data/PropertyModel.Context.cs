...
namespace Ashyana.Data
{
    ...
    public partial class PropertyDBEntities : DbContext
    {
        ...
        public DbSet<MapRoleLink> MapRoleLinks { get; set; }
        public DbSet<MapuserRoleLink> MapuserRoleLinks { get; set; }
        public DbSet<master> masters { get; set; }
        public DbSet<pp> pps { get; set; }
        public DbSet<Role> Roles { get; set; }
        public DbSet<SubLink> SubLinks { get; set; }
    
        [EdmFunction("PropertyDBEntities", "Split")]
        public virtual IQueryable<Split_Result> Split(string list, string splitOn)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Split_Result>("[PropertyDBEntities].[Split](@List, @SplitOn)", listParameter, splitOnParameter);
        }
    
        public virtual int test(string purchaseType, string propertyType, string country, string state, string city, string address, string metro, string bedroom, string minPrice, string maxPrice, string area, string age, string tenure, string pin, string propertyCreatedBy)
        {
            ...
            var propertyCreatedByParameter = propertyCreatedBy != null ?
                new ObjectParameter("propertyCreatedBy", propertyCreatedBy) :
                new ObjectParameter("propertyCreatedBy", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("test", purchaseTypeParameter, propertyTypeParameter, countryParameter, stateParameter, cityParameter, addressParameter, metroParameter, bedroomParameter, minPriceParameter, maxPriceParameter, areaParameter, ageParameter, tenureParameter, pinParameter, propertyCreatedByParameter);
        }
        ...
        public virtual ObjectResult<U_sp_CheckRight_Result> U_sp_CheckRight(Nullable<int> userID, Nullable<int> sublinkid)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_CheckRight_Result>("U_sp_CheckRight", userIDParameter, sublinkidParameter);
        }
        ...
        public virtual ObjectResult<U_sp_GetUserDetails_Result> U_sp_GetUserDetails(Nullable<int> uid)
        {
            var uidParameter = uid.HasValue ?
                new ObjectParameter("uid", uid) :
                new ObjectParameter("uid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_GetUserDetails_Result>("U_sp_GetUserDetails", uidParameter);
        }
        ...
        public virtual int U_sp_InsertUpdateRegistration(Nullable<int> userID, string userName, string userPassword, string userFirstname, string userLastname, Nullable<int> countryid, Nullable<int> stateid, Nullable<int> cityid, string userContactno, string userEmailID, Nullable<int> usertype, Nullable<int> usercreatedby)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
        ...
        public virtual ObjectResult<Nullable<decimal>> U_sp_InsertUpdateRole(Nullable<int> roleID, string roleName, string roleDescription, Nullable<int> roleCreatedBy)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("U_sp_InsertUpdateRole", roleIDParameter, roleNameParameter, roleDescriptionParameter, roleCreatedByParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> U_sp_InsertUpdateUser(Nullable<int> userID, string userName, string userFirstname, string userLastname, Nullable<int> countryid, Nullable<int> stateid, Nullable<int> cityid, string userEmailID, string userContactno, Nullable<int> userType, string userPassword, Nullable<int> userCreatedBy)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("U_sp_InsertUpdateUser", userIDParameter, userNameParameter, userFirstnameParameter, userLastnameParameter, countryidParameter, stateidParameter, cityidParameter, userEmailIDParameter, userContactnoParameter, userTypeParameter, userPasswordParameter, userCreatedByParameter);
        }
        ...
        public virtual ObjectResult<U_sp_RoleDropDown_Result> U_sp_RoleDropDown(Nullable<int> roleID)
        {
            var roleIDParameter = roleID.HasValue ?
                new ObjectParameter("RoleID", roleID) :
                new ObjectParameter("RoleID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_RoleDropDown_Result>("U_sp_RoleDropDown", roleIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_SearchByCity_Result> U_sp_SearchByCity(Nullable<int> cityID)
        {
            var cityIDParameter = cityID.HasValue ?
                new ObjectParameter("cityID", cityID) :
                new ObjectParameter("cityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SearchByCity_Result>("U_sp_SearchByCity", cityIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_SelectMapUserRole_Result> U_sp_SelectMapUserRole(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectMapUserRole_Result>("U_sp_SelectMapUserRole", userIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_SelectPropertyByID_Result> U_sp_SelectPropertyByID(Nullable<int> propertyID)
        {
            var propertyIDParameter = propertyID.HasValue ?
                new ObjectParameter("propertyID", propertyID) :
                new ObjectParameter("propertyID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectPropertyByID_Result>("U_sp_SelectPropertyByID", propertyIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_SelectRole_Result> U_sp_SelectRole()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectRole_Result>("U_sp_SelectRole");
        }
        ...
        public virtual ObjectResult<U_sp_SelectRoleLinkMapDropDown_Result> U_sp_SelectRoleLinkMapDropDown(Nullable<int> linkID)
        {
            var linkIDParameter = linkID.HasValue ?
                new ObjectParameter("linkID", linkID) :
                new ObjectParameter("linkID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectRoleLinkMapDropDown_Result>("U_sp_SelectRoleLinkMapDropDown", linkIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_SelectUser_Result> U_sp_SelectUser(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectUser_Result>("U_sp_SelectUser", idParameter);
        }
    
        public virtual ObjectResult<U_sp_SelectUserByID_Result> U_sp_SelectUserByID(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_SelectUserByID_Result>("U_sp_SelectUserByID", userIDParameter);
        }
        ...
        public virtual ObjectResult<U_sp_sMenu_Result> U_sp_sMenu(Nullable<int> uid)
        {
            var uidParameter = uid.HasValue ?
                new ObjectParameter("uid", uid) :
                new ObjectParameter("uid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_sMenu_Result>("U_sp_sMenu", uidParameter);
        }
        ...
        public virtual ObjectResult<U_sp_UpdateRoleLinkMapDropDown_Result> U_sp_UpdateRoleLinkMapDropDown(string linkName)
        {
            var linkNameParameter = linkName != null ?
                new ObjectParameter("linkName", linkName) :
                new ObjectParameter("linkName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<U_sp_UpdateRoleLinkMapDropDown_Result>("U_sp_UpdateRoleLinkMapDropDown", linkNameParameter);
        }
